...
/// <summary>Host-wide CPU/RAM figures at a single tick.</summary>
public sealed record HostResourceSample(double TotalCpuPercent, IReadOnlyList<double> PerCoreCpuPercent, long TotalRamBytes, long AvailableRamBytes, long ServiceRamBytes);
