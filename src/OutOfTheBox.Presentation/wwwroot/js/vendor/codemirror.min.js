 ...
 * the actual "expand/shrink" mechanism), and language modes for xml, javascript (also covers
 * json/typescript), css, htmlmixed (html), clike (also covers csharp/java/c/c++), shell,
